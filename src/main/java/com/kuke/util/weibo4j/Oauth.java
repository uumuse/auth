...
import com.kuke.util.weibo4j.http.AccessToken;
import com.kuke.util.weibo4j.http.BASE64Encoder;
import com.kuke.util.weibo4j.model.PostParameter;
import com.kuke.util.weibo4j.model.WeiboException;
import com.kuke.util.weibo4j.org.json.JSONException;
import com.kuke.util.weibo4j.org.json.JSONObject;
import com.kuke.util.weibo4j.util.WeiboConfig;
...
public class Oauth extends Weibo{
	...
	public JSONObject getAccessTokenInfoByAccessToken(String accessToken)
			throws WeiboException {
		return client.post(WeiboConfig.getValue("accessTokenInfoURL"), 
				new PostParameter[] {
					new PostParameter("access_token", accessToken)}, false).asJSONObject();
	}
	
	

	public String authorize(String response_type,String state,boolean forcelogin) throws WeiboException {
