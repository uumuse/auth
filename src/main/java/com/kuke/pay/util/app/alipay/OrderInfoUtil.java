...
public class OrderInfoUtil {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id,String biz_content,String method,String notify_url) {
		Map<String, String> keyValues = new HashMap<String, String>();
		...
		keyValues.put("timestamp", sf.format(new Date()));
