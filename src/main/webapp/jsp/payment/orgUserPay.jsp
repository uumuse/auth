...
<%-- <input type="hidden" id="orgMoneys" name="orgMoneys" value="${map.orgMoneys}"> --%>
<input type="hidden" id="orgFlag" name="orgFlag" value="${map.orgFlag}">
<div class="comSite422">
	<div class="comSite comWd01">
		...
		<div class="comSite428 comSite204a">
			<div class="comSite434">
				<div class="comSite435">
					<p class="comSt336">支付金额：<span>${map.cost_price}</span></p>
					<p class="comSt337">账户机构余额可支付：<span>${map.orgbalance}</span>元 <c:if test="${map.orgFlag}"><em>账户机构余额不足，剩余部分将使用个人账户或第三方支付</em></c:if> </p>
				</div>
			</div>
			<div class="comSite429">
				...
				<div class="comSite393 cf">
					...
					<div class="comSite394">
						...
						<div class="comSite402"><a href="javascript:void(0)" onclick="gotoPay('org');" class="comSt310">去支付</a></div>
					</div>
				</div>
			</div>
		</div>
