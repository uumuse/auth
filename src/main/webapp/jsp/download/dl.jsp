...
<head>
    ...
    <link type="text/css" href="js/download/HttpDownloader.css" rel="Stylesheet"/>
    <script type="text/javascript" src="js/download/HttpDownloader.js" charset="utf-8"></script>
</head>
<body>
